...
func mpcOp(stub shim.ChaincodeStubInterface, operation string, instanceName string, cell1 string, cell2 string) string {
	chainCodeArgs := ToChaincodeArgs("mpcOp", operation, "example", instanceName, cell1, cell2)
